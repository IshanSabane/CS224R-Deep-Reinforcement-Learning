...
class IQLAgent(DQNAgent):
    ...
    def estimate_advantage(self, ob_no, ac_na, re_n, next_ob_no, terminal_n,
        ...
        # HINT: we do not need to use all input arguments here, just the ones
        # that need to be passed to get_qvals. Ignore re_n, terminal_n, next_ob_no, and n_actions
    ...
    def train(self, ob_no, ac_na, re_n, next_ob_no, terminal_n):
        ...
        if (self.t > self.learning_starts
            ...
            # TODO 2): Calculate the awac actor loss (call update on self.awac_actor)
